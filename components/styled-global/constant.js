...
/* 统一 UI 样式 */
export const lineHeight = '180%' // 默认行高
export const fontSize = '1.6rem' // 默认字体大小
export const fontColor = '#000' // 默认字体颜色
export const fontAuxColor = '#aaa' // 默认字体辅助色
...
export const onePixelBorder = '@media (-webkit-min-device-pixel-ratio:2), (min-device-pixel-ratio:2) {border-width: 0.5px;}'
