                    ...
                    <div className="resume-body">
                        ...
                        <div className="content">
                            ...
                            <div className="form">
                                ...
                                <p>目前主要用来记录一些与技术有关或无关的点点滴滴，希望在浩瀚的互联网留下自己的一点点痕迹。后台文章发布用的是 WordPress 数据库，主站没有用默认 PHP 模板的搭建方式，而是前后端都用 JavaScript 编写，利用 Next + React + Nodejs 构建服务端渲染的 ReactApp，利于文章的直出和 SEO 收录。</p>
                            ...
                            <div className="form">
                                ...
                                <ul>
                                    ...
                                    <li>关于 Linux 操作，我目前所掌握和接触过的就是在自己买的腾讯云服务器上自动化部署我的博客了 😂。</li>
                                </ul>
